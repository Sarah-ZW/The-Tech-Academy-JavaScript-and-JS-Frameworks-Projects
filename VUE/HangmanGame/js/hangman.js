...
Vue.component("letter-button", {
    ...
    watch: {
        ...
        //reenable all buttons when a new two-player game is started
...
data: {
    ...
    currentWord: "",
    //each element in this array is a letter int he word
    wordDivs:[],
    ...
    lose: false,
    twoPlayers: false,
    //will be set to the cavas elemet in mounted()
    canvas: "",
...
methods: {
    ...
    //fill this.wordDivs with empty string to create the orange blanks
    makeBlanks: function() {
    ...
    updateCanvas: function(ctx) {
        ...
        //check the chosen letter when a letter coponent emits 'check'
...
//rests the game to one-player mode and chooses a new word
onePlayer: function() {
    if(this.twoPlayers) {
